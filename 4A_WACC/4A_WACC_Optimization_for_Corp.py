...
'''
econ = quandl.get("FRED/TEDRATE", authtoken="[quandl id]", start_date='2018-05-31', end_date='2018-07-31')
...
r2= record_db['workingcapital'] / record_db['assets']      
r3= record_db['assetsc'] / record_db['liabilitiesc']      
r4= record_db['gp'] / record_db['liabilitiesc']      
r5= ( record_db['gp'] + record_db['intexp'] ) / record_db['revenue']  
r6= record_db['revenue'] / record_db_t_1['revenue']      
...
r10= record_db['opex'] / record_db['liabilitiesc']      
r11= record_db['gp'] / record_db['assets']      
r12= record_db['ppnenet'] / record_db['assets']      
r13= record_db['gp'] / record_db['revenue']      
r14= ( record_db['assetsc'] - record_db['inventory'] - record_db['receivables'] ) / record_db['liabilitiesc']
r15= ( record_db['assetsc'] - record_db['inventory'] ) / record_db['liabilitiesc']  
r16= record_db['ebitda'] / record_db['assets']      
r17= record_db['liabilitiesc'] / record_db['liabilities']      
r18= record_db['liabilitiesc'] / record_db['assets']      
r19= ( record_db['revenue'] - record_db['cor'] ) / record_db['revenue']  
r20= record_db['revenue'] / record_db['liabilitiesc']      

X_test = [r1[0],r2[0],r3[0],r4[0],r5[0],r6[0],r7[0],r8[0],r9,r10[0],r11[0],r12[0],r13[0],r14[0],r15[0],r16[0],r17[0],r18[0],r19[0],r20[0]]
